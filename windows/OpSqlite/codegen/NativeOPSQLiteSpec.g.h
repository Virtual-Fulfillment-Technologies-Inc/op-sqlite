...
inline winrt::Microsoft::ReactNative::FieldMap GetStructInfo(OPSQLiteSpec_Constants*) noexcept {
    winrt::Microsoft::ReactNative::FieldMap fieldMap {
        ...
        {L"WINDOWS_LOCAL_FOLDER", &OPSQLiteSpec_Constants::WINDOWS_LOCAL_FOLDER},
        {L"WINDOWS_TEMP_FOLDER", &OPSQLiteSpec_Constants::WINDOWS_TEMP_FOLDER},
        {L"WINDOWS_DATABASE_PATH", &OPSQLiteSpec_Constants::WINDOWS_DATABASE_PATH},
    };
    return fieldMap;
}
